...
The Figure REF shows an example of the vocabulary (italian version) we
used to perform bills classification, how we can see, it is very small
and effective.  Before manually building the vocabulary, we tried to
let the machine builds automatically it. See the experiment reported
in Section REF.
...
- naive bayes on vocabulary extracted text? (VEDERE SE METTERE O MENO)
